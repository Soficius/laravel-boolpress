            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <router-link class="btn btn-primary" :to="{name:'post-detail', params:{slug: post.slug} }">Vedi</router-link>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...
        formatedData() {
            ...
            // faccio il +1 perchè js iniza a contare i mesi da zero
            let month = postDate.getMonth() + 1 ;
            let year = postDate.getYear();

            // la funzione parla da sola
            if (day < 10) day = "0" + day;
